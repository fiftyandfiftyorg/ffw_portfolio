...
function ffw_port_add_menu_page() {
    ...
    $ffw_port_settings_page = add_submenu_page( 'edit.php?post_type=ffw_port', __( 'Settings', 'ffw_port' ), __( 'Settings', 'ffw_port'), 'edit_pages', 'staff-settings', 'ffw_port_settings_page' );
